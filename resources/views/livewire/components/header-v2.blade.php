<header>
    <livewire:search-v2/>
    <div class="relative z-50" @keydown.window.escape="navIsOpen = false" @click.away="navIsOpen = false">
        <div class="relative max-w-screen-2xl mx-auto w-full py-3 bg-white transition duration-200">
