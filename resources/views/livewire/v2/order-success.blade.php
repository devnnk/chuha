...
<circle style="fill:#25AE88;" cx="25" cy="25" r="25"/>
	...
	38,15 22,33 12,25 "/>
            ...
            <div class="md:w-1/2 md:pl-8 lg:pl-24">
                <h1 class="sm:text-4xl lg:text-5xl lg:leading-tight xl:text-5xl text-3xl font-medium tracking-tight">
                    Order success!</h1>
                <h3>Order id: </h3>
                <p class="sm:mt-5 md:max-w-2xl md:mt-8 md:text-lg max-w-xl mt-3 text-gray-600">Thank for order! We will contact you later.</p>
